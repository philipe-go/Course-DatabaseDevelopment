...
public class Program {
	public static void main(String[] args)
	{
		...
		//System.out.println("aa.p2 = "+aa.p2prot); //--> PROGRAM IS NOT DESCENDENT FOR PROTECTED (only visible same pack or derived from A)
		//System.out.println("aa.p3 = "+aa.p3non); //--> PROGRAM IS NOT DESCENDENT FOR DEFAULT (only visible inside same pack as class A)
