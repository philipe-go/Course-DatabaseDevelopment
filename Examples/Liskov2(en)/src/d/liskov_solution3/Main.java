...
public class Main {
	...
	public static void test (AbsRectangleSquare r) {
...
//		r.setHs(2*r.getHs());            // there is no way to duplicate the horizontal side in the abstract class
...
//		}
	...
	public static void test2 (AbsRectangleSquare r) {
